      ...
      ?>   
        ...
        <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="email">Email <span class="required">*</span>
            ...
            <div class="col-md-6 col-sm-6 col-xs-12"> 
            <input type="text" placeholder="Email" required="required" name="identity">
          </div>
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">Confirm Password <span class="required">*</span>
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="password" placeholder="Confirm Password" required="required" name="password_confirm">
          </div>
        </div>
        <div class="form-group" >
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">Select Country<span class="required">*</span>
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
            <select name="country" class="col-md-7 col-xs-12" data-parsley-group="first">
         ...
         <div class="form-group">
          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="password">Select Plan<span class="required">*</span>
             ...
             <div class="col-md-6 col-sm-6 col-xs-12">
            <select id="plan" name='plan' class="form-control col-md-7 col-xs-12" data-parsley-group="first">
